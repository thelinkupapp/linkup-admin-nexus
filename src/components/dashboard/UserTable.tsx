    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="text-sm text-muted-foreground">
          Showing {paginatedUsers.length > 0 ? startIndex + 1 : 0}-{Math.min(startIndex + itemsPerPage, filteredUsers.length)} of {filteredUsers.length} users
        </div>
            ...
            <PaginationContent>
              ...
              {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                ...
                if (totalPages <= 5) {
                  ...
                  if (i === 1) return (
                    <PaginationItem key="ellipsis-after-start">
                      <PaginationEllipsis />
                    </PaginationItem>
                  );
                  if (i === 3) return (
                    <PaginationItem key="ellipsis-before-end">
                      <PaginationEllipsis />
                    </PaginationItem>
                  );
                  if (i === 4) return (
