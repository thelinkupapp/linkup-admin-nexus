                  ...
                  <CardContent>
                    <div className="space-y-6">
                      <div>
                        ...
                        <p>{isVerified ? 'Approved' : 'Pending'}</p>
                      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-6">
                      <div>
                        <p className="text-sm font-medium text-muted-foreground mb-2">Received Reports</p>
                        <div className="flex flex-wrap gap-2">
                          {user.reportsReceived.map(report => (
                            <Badge key={report.id} variant="outline" className="bg-muted/50">
                              {report.description}
                            </Badge>
                          ))}
                        </div>
                      ...
                      <div>
                        <p className="text-sm font-medium text-muted-foreground mb-2">Made Reports</p>
                        <div className="flex flex-wrap gap-2">
